...
use rsiripong\rbac\models\Search;
...
abstract class ItemControllerAbstract extends Controller
{
    /**
     * @param  string $name
     * @return \rsiripong\rbac\models\Role|\rsiripong\rbac\models\Permission
     */
    ...
    {
        /** @var \rsiripong\rbac\models\Role|\rsiripong\rbac\models\Permission $model */
